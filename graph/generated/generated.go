...
type Mutation {
  user: UserOps! @goField(forceResolver: true)
	...
	{Name: "graph/user.graphqls", Input: `# User Data Schema
type User {
    name: String!
    email: String!
    age: Int!
...
func (ec *executionContext) _User_country_id(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) unmarshalInputNewUser(ctx context.Context, obj interface{}) (model.NewUser, error) {
	...
	for k, v := range asMap {
		...
		case "age":
			...
			directive1 := func(ctx context.Context) (interface{}, error) {
				constraint, err := ec.unmarshalNString2string(ctx, "gte=0,lte=128")
				if err != nil {
					return nil, err
				}
				if ec.directives.Binding == nil {
		...
		case "country_id":
			...
			directive0 := func(ctx context.Context) (interface{}, error) { return ec.unmarshalNString2string(ctx, v) }
			directive1 := func(ctx context.Context) (interface{}, error) {
				constraint, err := ec.unmarshalNString2string(ctx, "required,iso3166_1_alpha2")
				if err != nil {
					return nil, err
				}
				if ec.directives.Binding == nil {
...
func (ec *executionContext) _User(ctx context.Context, sel ast.SelectionSet, obj *model.User) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "country_id":
			out.Values[i] = ec._User_country_id(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
